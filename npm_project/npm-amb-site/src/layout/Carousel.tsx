...
const Carousel:React.FC<Carousel> = ({ slides, mediaByIndex, lang }):JSX.Element => {
	...
	const toScrollIndex = useCallback((index:number) => embla && embla.scrollTo(index), [embla])
