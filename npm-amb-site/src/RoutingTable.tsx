...
const RoutingTable: React.FC<LanguageSettings> = ({ lang }): JSX.Element => {
	...
	return (
		<div className={transitionStage} onAnimationEnd={changeContent}>
			<Routes location={curLocation}>
				<Route
					path="/"
					element={<IntroPage data={cleanData()} lang={lang} />}
				/>
				<Route
					path="/about"
					element={<AboutPage data={cleanData()} />}
				></Route>
				<Route
					path="/intro"
					element={<IntroPage data={cleanData()} lang={lang} />}
				...
				<Route
					...
					element={<RecommendPage data={cleanData()} lang={lang} />}
				></Route>
				<Route
					path="/workshop"
					element={<WorkshopPage data={cleanData()} lang={lang} />}
				></Route>
			</Routes>
		</div>
	);
